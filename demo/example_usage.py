...
example_usage.py
================
How a developer uses undertow_llm in 3 steps:

    1. pip install undertow-llm
...
from undertow_llm import track, configure, PolicyViolationError, get_last_call_info
...
if __name__ == "__main__":
    ...
    print("     undertow-llm serve  →  http://localhost:8080")
