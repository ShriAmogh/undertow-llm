...
from gateway_sdk.cache.semantic import embed
from gateway_sdk.backends.factory import get_cache_backend, get_metrics_store
from gateway_sdk.logging.store import LogEntry
from gateway_sdk.retry import retry_with_backoff, DEFAULT_RETRY_ON
from gateway_sdk.fallback import FallbackChain
from gateway_sdk.rate_limiter import get_limiter
from gateway_sdk.queue import get_queue
from gateway_sdk.streaming import is_generator, wrap_stream
from gateway_sdk.tracing import get_current_trace, set_current_trace, reset_current_trace
from gateway_sdk.canary import parse_canary, should_use_canary
...
def track(
    ...
    """
    Decorator factory that wraps an LLM call function with gateway-sdk features.
...
def _wrapper_body(
    ...
    if is_generator(response):
        ...
        if isinstance(response, _types.AsyncGeneratorType):
            from gateway_sdk.streaming import wrap_async_stream
