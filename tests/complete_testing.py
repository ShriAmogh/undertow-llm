...
complete_testing.py
===================
End-to-end integration test script for gateway-sdk (Phases 1–4).
...
os.environ.pop("GATEWAY_SDK_POSTGRES_URL", None)
...
os.environ.setdefault("GATEWAY_DB_PATH", ":memory:")  # overridden per test
...
from gateway_sdk.config import configure, get_config, GatewayConfig
from gateway_sdk.db import init_db, get_connection
...
import numpy as np
from gateway_sdk.cache.semantic import embed, cosine_similarity, embedding_to_bytes, bytes_to_embedding
from gateway_sdk.cache.store import CacheStore
...
from gateway_sdk.retry import retry_with_backoff, compute_delay
