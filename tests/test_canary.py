...
====================
Unit tests for undertow_llm.canary (Phase 9).
"""
import pytest
from undertow_llm.canary import parse_canary, should_use_canary, CanaryConfig
...
def test_decorator_always_routes_to_canary(temp_db):
    ...
    from undertow_llm.decorator import track
