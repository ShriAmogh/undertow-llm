"""
undertow_llm.backends.postgres_backend
====================================
...
from undertow_llm.backends.base import CacheBackend, CacheEntry, MetricsStore
    ...
    def _init_tables(self, conn: Any) -> None:
        with conn.cursor() as cur:
            ...
            try:
                ...
                logger.warning(f"[undertow_llm] pgvector extension initialization warning: {e}")
...
class PostgresCacheBackend(CacheBackend):
    ...
    def lookup(
        ...
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresCacheBackend lookup error: {e}")
            return None
    ...
    def write(
        ...
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresCacheBackend write error: {e}")
    ...
    def count(self) -> int:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresCacheBackend count error: {e}")
            return 0
...
class PostgresMetricsStore(MetricsStore):
    ...
    def log_request(self, entry: Any) -> None:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore log_request error: {e}")
    ...
    def get_stats(self) -> Dict[str, Any]:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore get_stats error: {e}")
            return {
    ...
    def get_recent_logs(self, limit: int = 50) -> List[Dict[str, Any]]:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore get_recent_logs error: {e}")
            return []
    ...
    def get_trends(self, bucket_minutes: int = 5, limit_buckets: int = 24) -> List[Dict[str, Any]]:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore get_trends error: {e}")
            return []
    ...
    def get_cost_since(self, since_ts: float) -> float:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore get_cost_since error: {e}")
            return 0.0
    ...
    def get_canary_stats(self) -> List[Dict[str, Any]]:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore get_canary_stats error: {e}")
            return []
    ...
    def get_traces(self, limit: int = 20) -> List[Dict[str, Any]]:
        try:
            ...
            logger.warning(f"[undertow_llm] PostgresMetricsStore get_traces error: {e}")
            return []
