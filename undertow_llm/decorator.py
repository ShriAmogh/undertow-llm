...
from undertow_llm.cache.semantic import embed
from undertow_llm.backends.factory import get_cache_backend, get_metrics_store
from undertow_llm.logging.store import LogEntry
from undertow_llm.retry import retry_with_backoff, DEFAULT_RETRY_ON
from undertow_llm.fallback import FallbackChain
from undertow_llm.rate_limiter import get_limiter
from undertow_llm.queue import get_queue
from undertow_llm.streaming import is_generator, wrap_stream
from undertow_llm.tracing import get_current_trace, set_current_trace, reset_current_trace
from undertow_llm.canary import parse_canary, should_use_canary
...
def track(
    ...
    """
    Decorator factory that wraps an LLM call function with undertow_llm features.
...
def _wrapper_body(
    ...
    if is_generator(response):
        ...
        if isinstance(response, _types.AsyncGeneratorType):
            from undertow_llm.streaming import wrap_async_stream
